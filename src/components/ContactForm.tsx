...
Meu nome é ${formData.name}, meu número é ${formData.whatsapp}, sou do nicho ${formData.business} e estou buscando ${formData.needs}.`;
    ...
    const whatsappUrl = `https://wa.me/5515981479735?text=${encodeURIComponent(message)}`;
    ...
    toast({
      ...
      description: "Seus dados foram enviados. Continue a conversa no WhatsApp.",
    });
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl mx-auto">
          ...
          <Card className="bg-card/50 backdrop-blur-sm border-border animate-fade-in">
            <CardHeader>
              <CardTitle>Fale comigo agora</CardTitle>
              <CardDescription>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  className="w-full bg-primary hover:bg-primary/90 shadow-neon-blue text-lg"
                  size="lg"
                >
